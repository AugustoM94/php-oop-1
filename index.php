...
class Movie 
{
    ...
    public function print()
    {
        ...
        echo "<p>ID: {$this->id}</p>";
        echo "<p>Overview: {$this->overview}</p>";
        echo "<p>Vote Average: {$this->vote_average}</p>";
        echo "<img src='{$this->poster_path}' alt='logo'>";
        echo "";
        echo "<p>Original Language: {$this->original_language}</p>";
        echo "<hr>";
